...
<body>
	...
	<label>이름:</label>
	 <input type="text" name="name" value="${map.name }" readonly><br><br>
	<div class="result-images">
	  <c:forEach var="imageFileName" items="${ map.fileList}"  >
			 ...
			 <a href="${pageContext.request.contextPath }/download?imageFileName=${imageFileName }">${imageFileName} 다운로드</a>
	         <br><br><br>
	  </c:forEach>         
	</div>
