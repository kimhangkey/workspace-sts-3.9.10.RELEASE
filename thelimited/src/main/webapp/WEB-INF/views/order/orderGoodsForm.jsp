...
<!-- 총 배송비 -->
<c:set var="total_delivery_price" value="4000" />
					...
					<div class="border-top border-main border-2 mt-2">
						<div class="shadow-sm p-4 pt-2 mt-3 rounded border border-light">
							...
							<p
								...
								<!-- 총 배송비 -->
									<span>+</span> <span>총 배송비 </span>
									<span>
										<fmt:formatNumber value="${total_delivery_price}" pattern="#,###" />
									</span> <span>원</span>
								<!-- 총 배송비 --> 
							...
							<tr class="whenSelected_Card">
								...
								<td class="px-4">
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											<select id="" name="" class="form-select rounded-0 pay_select" onchange="selectValue(this, this.value)">
