...
<!-- 회원정보 표시 영역 -->
					...
					<div class="table-responsive mt-4">
						<table
							class="table border-top mb-0  fw-light border-bottom member_table">
							<tbody>
...
//버튼식 상품조회
//onclick할때 같이 가져오는 fixedSearchPeriod값과함께 adminMember 재요청
		...
		$.ajax({
			...
			success : function(data, textStatus) {
				if(data.trim()=='delete_success'){
					alert("삭제되었습니다.");
					location.href="${contextPath}/admin/member/adminMember.do";
