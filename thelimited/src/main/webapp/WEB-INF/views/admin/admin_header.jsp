						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu">
								<ul class="standard_dropdown main_nav_dropdown">
									<li class="menu_home"><span>관리자 페이지</span></li>
									<li class="menu_line"><span>&nbsp;&#124;</span></li>
									<li><a href="${contextPath}/admin/goods/adminGoods.do">상품관리<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="${contextPath}/admin/order/adminOrder.do">주문관리<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="${contextPath}/admin/member/adminMember.do">회원관리<i class="fas fa-chevron-down"></i></a></li>
								</ul>
							</div>
