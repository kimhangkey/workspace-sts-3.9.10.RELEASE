		...
		<c:choose>
			...
			<c:when test="${!empty articlesList}">
				<c:forEach var="article" items="${articlesList }"
					varStatus="articleNum" step="1">
					<tr align="center">
						<td width="5%">${articlesList.size() - articleNum.count + 1}</td>
...
<br><br>
	...
	<p class="cls2"><a class="cls1" href="javascript:fn_articleForm('${isLogOn}','${contextPath}/board/articleForm.do', 
                                                    '${contextPath}/member/loginForm.do')">글쓰기</a></p>
</body>
</html>